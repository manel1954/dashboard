...
for ($i = 0; $i < $maxCount; $i++) {
	...
	if (is_numeric($listElem[2]) || strpos($listElem[2], "openSPOT") !== FALSE) {
		...
		/* echo "<td style=\"font-size:40px;\">$listElem[2]</td>"; */
		...
		// ==============================================================================================================
		if ($listElem[6] == null) {
			echo "<td style=\"font-size:30px;height:80px;background:#000;color:#fff\">$listElem[2]</td>"; //el indicativo que habla
		} else {		
		}
		// ==============================================================================================================
        
		if ($listElem[5] == "RF"){
			echo "<td align=\"left\" style=\"background:#5a39dd;color:#fff\">$listElem[2]</td>";//mi indicativo despues de soltar el ptt					
		} else {
